          ...
          <div class="service">
                        ...
                        <div class="workshops" v-if="workshops && workshops.length > 0">
                            <div class="clinic" v-for="(clinic, index) in workshops" :key="index">
                                <div class="head" v-b-toggle="'collapse-' + index">
                                    <h3>{{ workshops[index].langs[0].title }}</h3>
                                        ...
                                        <div class="partner-form">
                                            <div class="form-row justify-content-between">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input
                                                        @input="$v.workshops.$each[index].langs.$each[0].title.$touch()"
                                                        v-model="workshops[index].langs[0].title"
                                                        :class="{ invalid: $v.workshops.$each[index].langs.$each[0].title.$error }"
                                                        type="text"
                                                        class="form-control form-control-lg"
                                                        id="clinicName"
                                                    />
                                                    <template v-if="$v.workshops.$each[index].langs.$each[0].title.$error">
                                                        <small v-if="!$v.workshops.$each[index].langs.$each[0].title.required" class="form-text text-muted">
                                                            <span>This field is required</span>
                                                        </small>
                                                    </template>
                                                </div>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-12">
                                                    ...
                                                    <textarea
                                                        @input="$v.workshops.$each[index].langs.$each[0].description.$touch()"
                                                        :class="{ invalid: $v.workshops.$each[index].langs.$each[0].description.$error }"
                                                        v-model="workshops[index].langs[0].description"
                                                        class="form-control" 
                                                        id="workshop-description" 
                                                        rows="4">
                                                    </textarea>
                                                    <template v-if="$v.workshops.$each[index].langs.$each[0].description.$error">
                                                        <small class="form-text text-muted">
                                                            <span v-if="!$v.workshops.$each[index].langs.$each[0].description.required">This field is required</span>
                                                        </small>
                                                    </template>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-row justify-content-between">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input
                                                        @input="$v.workshops.$each[index].langs.$each[0].address.$touch()"
                                                        :class="{ invalid: $v.workshops.$each[index].langs.$each[0].address.$error }"
                                                        v-model="workshops[index].langs[0].address"
                                                        type="text"
                                                        class="form-control form-control-lg"
                                                        id="address"
                                                    />
                                                    <template v-if="$v.workshops.$each[index].langs.$each[0].address.$error">
                                                        <small class="form-text text-muted">
                                                            <span v-if="!$v.workshops.$each[index].langs.$each[0].address.required">This field is required</span>
                                                        </small>
                                                    </template>
                                                </div>
                                                <div class="form-group col-md-6">
            ...
            <b-modal id="modal-lang" title="BootstrapVue" centered size='lg' @hidden='modalHidden' hide-footer hide-header>
                ...
                <div class="personal-form">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            ...
                            <input
                                @input="$v.personalTranslate.commercialName.$touch()"
                                :class="{ invalid: $v.personalTranslate.commercialName.$error }"
                                v-model="personalTranslate.commercialName"
                                type="text"
                                class="form-control form-control-lg"
                                id="lang-title"
                            />
                            <template v-if="$v.personalTranslate.commercialName.$error">
                                <small class="form-text text-muted">
                                <span v-if="!$v.personalTranslate.commercialName.required">This field is required</span>
                                </small>
                            </template>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-12">
                        <label for="lang-shortDescription">Short Description</label>
                        <textarea
                            @input="$v.personalTranslate.shortDescription.$touch()"
                            :class="{ invalid: $v.personalTranslate.shortDescription.$error }"
                            v-model="personalTranslate.shortDescription"
                            class="form-control"
                            id="lang-shortDescription"
                            rows="2"
                        ></textarea>
                        <template v-if="$v.personalTranslate.shortDescription.$error">
                            <small class="form-text text-muted">
                            <span v-if="!$v.personalTranslate.shortDescription.required">This field is required</span>
                            </small>
                        </template>
                        </div>
                    </div>
                    <div class="form-row">
                        ...
                        <textarea
                            @input="$v.personalTranslate.description.$touch()"
                            :class="{ invalid: $v.personalTranslate.description.$error }"
                            v-model="personalTranslate.description"
                            class="form-control"
                            id="description"
                            rows="4"
                        ></textarea>
                        <template v-if="$v.personalTranslate.description.$error">
                            <small class="form-text text-muted">
                            <span v-if="!$v.personalTranslate.description.required">This field is required</span>
                            </small>
                        </template>
                        </div>
                    </div>
                ...
                <div class="business-form">
                    <h4>Workshops Translations</h4>

                    <div class="form-row">

                        <div class="form-group col-md-12">
                            <label for="lang">Select Workshop</label>
                            <select 
                                ...
                                <option :value='workshop'>{{workshop.title}}</option>
                                <option :value="workshop" v-for="(workshop, index) in translatedWorkshops" :key="index">{{workshop.title}}</option>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            <label for="lang-workshop-title">Title</label>
                            <input
                                v-model="businessTranslate.title"
                                type="text"
                                class="form-control form-control-lg"
                                id="lang-workshop-title"
                            />
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            <label for="lang-add">Address</label>
                            <input
                                v-model="businessTranslate.address"
                                type="text"
                                class="form-control form-control-lg"
                                id="lang-add"
                            />
                    ...
                    <div class="form-row">
                        ...
                        <textarea
                            v-model="businessTranslate.description"
                            class="form-control"
                            id="lang-description"
                            rows="4"
                        ></textarea>
                    ...
                    <div class="add-btn"><!-- :disabled="$v.businessForm.$invalid" -->
                        <button type="button" class="btn" :disabled="$v.businessTranslateFrom.$invalid" @click="addWorkshopTranslate">+ Add Translate</button>
                    </div>

                </div>

                <div class="btn-section" v-if="!editMode">
                ...
                <!-- <div class="btn-section" v-else @click="saveLang">
                    <button class="auction-btn" :disabled="$v.translateForm.$invalid">
...
export default {
  ...
  validations() {
      return {
        ...
        translateForm: ['selectedLang', 'personalTranslate.commercialName', 'personalTranslate.shortDescription','personalTranslate.description'],
        businessTranslateFrom: ['selectedWorkshop', 'businessTranslate.title', 'businessTranslate.address', 'businessTranslate.description']
      }
  ...
  methods: {
    ...
    addWorkshopTranslate() {

        if(this.selectedWorkshop.id == 0) {

            this.defaultWorkshopTranslates.push({
                langCode: this.selectedLang.code,
                langName: this.selectedLang.name,
                ...this.businessTranslate
            });

            console.log('default workshop translates > ', this.defaultWorkshopTranslates)

            return;
        }

        let workshop = this.workshops.find(workshop => {
            return workshop.id == this.selectedWorkshop.id
        });
        ...
        let index = this.translatedWorkshops.findIndex(ele => {
            return ele.id == this.selectedWorkshop.id
        });

        this.translatedWorkshops.splice(index, 1);

        this.selectedWorkshop = ''

        console.log('added translate >> ', this.workshops, workshop, this.selectedWorkshop);
    ...
    modalHidden() {
      ...
      if(this.editMode) {
        ...
        this.selectedLangs[this.selectedLang.code] = {
          ...this.personalTranslate
        }
        this.selectedLang = '';
        this.personalTranslate.commercialName = '';
        this.personalTranslate.shortDescription = '';
        this.personalTranslate.description = '';
