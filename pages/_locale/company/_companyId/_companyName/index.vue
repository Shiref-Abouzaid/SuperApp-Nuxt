        ...
        <div class="container">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><nuxt-link :to="`/${local}/companies-categories/`">{{$t("menu.companies_index")}}</nuxt-link></li>
                    <!-- <li class="breadcrumb-item"><nuxt-link to="/">{{$route.params.}}</nuxt-link></li> -->
                    <li class="breadcrumb-item active" aria-current="page">{{$route.params.companyName}}</li>
                </ol>
            </nav>
            ...
            <div class="row">
                <div class="col-sm-8">
                    ...
                    <div class="details">
                        <div class="head">
                            <h3>{{$t("companies_index.about") + ' ' + company.title }}</h3>
                  ...
                  <div class="reviews">
                        <div class="add-review">
                            ...
                            <div class="row no-gutters">
                                <div class="col-3"></div>
                                <div class="col-9">
                                    <button @click="saveComment" class="btn">{{$t("vip.submit")}}</button>
                                </div>
                            </div>
                        </div>
                        <hr>
                ...
                <div class="col-sm-4">
                    <div class="vendor-profile">
                        ...
                        <div class="info">
                            ...
                            <div class="rate">
                                <span>{{company.total_rates}}</span>
                                <img src="/images/icons/svg/vendor-star.svg" alt="">
                            </div>
                        </div>
                        <hr>
                        <div class="contacts">
                            <div class="row no-gutters" v-if="company.phone">
                                <div class="col-1"><img src="/images/icons/svg/phone.svg" alt=""></div>
                                <div class="col-1"></div>
                                <div class="col-10"><p>{{ company.phone }}</p></div>
                            </div>
                            <div class="row no-gutters" v-if="company.email">
                                <div class="col-1"><img class="mail" src="/images/icons/svg/mail.svg" alt=""></div>
                                <div class="col-1"></div>
                                <div class="col-10"><p>{{company.email}}</p></div>
                            </div>
                            <div class="row no-gutters" v-if="company.address">
                                <div class="col-1"><img src="/images/icons/svg/location.svg" alt=""></div>
                                <div class="col-1"></div>
                                <div class="col-10"><p>{{company.address}}</p></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        async saveComment() {
            ...
            if(this.$store.getters['auth/isAuthenticated']) {
                ...
                let rateObj = {
                    ...
                    object_name: 'catalogue', // or catalouge?
                    comment: this.comment
                }
