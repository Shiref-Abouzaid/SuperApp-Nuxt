      ...
      <div class="company-content">
        ...
        <form @submit.prevent="onSave">
          ...
          <div class="row justify-content-around">
            <div class="form-group col-md-5">
              ...
              <template v-if="$v.website.$error">
                <small class="form-text text-muted">
                  <span v-if="!$v.website.required">This field is required</span>
                  <span v-if="!$v.website.url">Enter valid URL (ex: http://www.tbdm.net)</span>
                </small>
              </template>
            </div>
            <div class="form-group col-md-5">
          ...
          <div class="form-row justify-content-center">
            <div class="form-group col-11">
              ...
              <input
                ...
                @input="$v.businessActivity.$touch()"
                :class="{ invalid: $v.businessActivity.$error }"
                class="form-control"
                id="activity"
                rows="4"
              />
              <template v-if="$v.businessActivity.$error">
                <small class="form-text text-muted">
                  <span v-if="!$v.businessActivity.required">This field is required</span>
                </small>
              </template>
            </div>
          </div>
          ...
          <button class="company-btn" :disabled="$v.mainForm.$invalid || isLoading">
              ...
              <span v-if="!isLoading">Add Company</span>
          </button>
          </div>
        </form>
