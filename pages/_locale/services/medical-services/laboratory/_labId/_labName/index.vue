...
export default {
    ...
    async fetch() {
        try {
            let clinicData = await axios.get('/my/laboratory/' + this.$route.params.labId);
    ...
    methods: {
        getMoreReviews(skip,take) {
            ...
            axios.get(`my/rates/type/clinic/object-id/${this.$route.params.labId}/skip/${skip}/take/${take}`)
            .then(res=>{
        ...
        onConfirm() {
            ...
            let reservation = {
                ...
                clinic_id: this.$route.params.labId
            }
        ...
        async saveComment() {
            ...
            if(this.$store.getters['auth/isAuthenticated']) {
                ...
                let rateObj = {
                    rate: this.rate,
                    user_id:userId,
                    object_id: this.$route.params.labId,
                    object_name: 'clinic',
                    comment: this.comment
                }
