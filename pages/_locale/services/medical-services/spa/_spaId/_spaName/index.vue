...
export default {
    ...
    async fetch() {
        try {
            let clinicData = await axios.get('/my/spa/' + this.$route.params.spaId);
    ...
    methods: {
        getMoreReviews(skip,take) {
            ...
            axios.get(`my/rates/type/clinic/object-id/${this.$route.params.spaId}/skip/${skip}/take/${take}`)
            .then(res=>{
        ...
        async saveComment() {
            ...
            if(this.$store.getters['auth/isAuthenticated']) {
                ...
                let rateObj = {
                    rate: this.rate,
                    user_id:userId,
                    object_id: this.$route.params.spaId,
                    object_name: 'clinic',
                    comment: this.comment
                }
