        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ $t("subnav.pharmacy_name") }}</li>
                </ol>
            </nav>
            ...
            <div class="row">
                <div class="col-sm-8">
                    ...
                    <div v-for="(clinic, index) in clinic.clinics" :key="index">
                        <div class="clinic">
                            <div class="head">
                                <h3>{{ clinic.title }}</h3>
...
export default {
    ...
    async fetch() {
        try {
            let clinicData = await axios.get('/my/hospital/' + this.$route.params.hospitalId);
    ...
    methods: {
        getMoreReviews(skip,take) {
            ...
            axios.get(`my/rates/type/clinic/object-id/${this.$route.params.hospitalId}/skip/${skip}/take/${take}`)
            .then(res=>{
        ...
        onConfirm() {
            ...
            let reservation = {
                ...
                clinic_id: this.$route.params.hospitalId
            }
        ...
        async saveComment() {
            ...
            if(this.$store.getters['auth/isAuthenticated']) {
                ...
                let rateObj = {
                    rate: this.rate,
                    user_id:userId,
                    object_id: this.$route.params.hospitalId,
                    object_name: 'clinic',
                    comment: this.comment
                }
