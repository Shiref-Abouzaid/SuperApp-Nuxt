        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ $route.params.doctorName }}</li>
                </ol>
            </nav>

            <div class="row">
                <div class="col-sm-8" v-if="doctor">
                    <div class="doctor-info">
                        <div class="info">
                            <div class="doctor-img">
                                <img :src="doctor.image_url ? doctor.image_url : '/images/placeholder.jpg'" alt="">
                            </div>
                            <div class="title">
                    ...
                    <div v-for="(clinic, index) in doctor.medical_services" :key="index">
                        <div class="clinic" v-if="clinic.type == 'clinic'">
                            <div class="head">
                                <h3>{{ clinic.title }}</h3>
                            ...
                            <div class="clinic-contacts">
                                <div class="contacts">
                                    <div class="row">
                                        <div class="col-md-6" v-if="clinic.phone">
                                            <div class="contact">
                                                <img src="/images/icons/svg/phone.svg" alt="">
                                                <p>{{clinic.phone}}</p>
                                            </div>
                                        </div>
                                        <div class="col-md-6" v-if="clinic.email">
                                            <div class="contact">
                                                <img class="mail" src="/images/icons/svg/mail.svg" alt="">
                                                <p>{{ clinic.email }}</p>
                                            </div>
                                        </div>
                                        <div class="col-md-6" v-if="clinic.address">
                                            <div class="contact">
                                                <img src="/images/icons/svg/location.svg" alt="">
                                                <p class="location">{{ clinic.address }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="appointments">
                                <div class="swiper arrow-secondary" v-swiper="swiperOption" :instance-name="'mySwiper' + index">
                ...
                <div class="col-sm-4">
                    <div class="doctor-contacts">
                        <div class="contacts" v-if="doctor">
                            <div class="row no-gutters" v-if="doctor.phone">
                                <div class="col-1"><img src="/images/icons/svg/phone.svg" alt=""></div>
                                <div class="col-1"></div>
                                <div class="col-10"><p>{{ doctor.phone }}</p></div>
                            </div>
                            <div class="row no-gutters" v-if="doctor.email">
                                <div class="col-1"><img class="mail" src="/images/icons/svg/mail.svg" alt=""></div>
                                <div class="col-1"></div>
                                <div class="col-10"><p>{{ doctor.email }}</p></div>
                            </div>
                            <div class="row no-gutters" v-if="doctor.address">
                                <div class="col-1"><img src="/images/icons/svg/location.svg" alt=""></div>
                                <div class="col-1"></div>
                                <div class="col-10"><p>{{ doctor.address }}</p></div>
                            </div>
                        </div>
                    </div>
                </div>
...
export default {
    ...
    async fetch() {
        let doctorData = await axios.get('/my/doctor/user/' + this.$route.params.doctorId);
        console.log('doctor data >> ', doctorData.data.data);
        this.doctor = doctorData.data.data;
        this.reviews = this.doctor.rates;
    },
    methods: {
        //get more reviews
        getMoreReviews(skip,take) {
            ...
            axios.get(`my/rates/type/doctor/object-id/${this.$route.params.doctorId}/skip/${skip}/take/${take}`)
            .then(res=>{
        ...
        async saveComment() {
            ...
            if(this.$store.getters['auth/isAuthenticated']) {
                ...
                let rateObj = {
                    rate: this.rate,
                    user_id:userId,
                    object_id: this.$route.params.doctorId,
                    object_name: 'doctor',
                    comment: this.comment
                }
