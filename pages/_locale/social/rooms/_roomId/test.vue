                                            ...
                                            <div class="message">
                                                <template v-if="message.attachment">
                                                    ...
                                                    <video v-else-if="message.attachment.content && (message.attachment.type == 'video')" width="320" height="240" controls>
                                                        <source :src="message.attachment.content" type="video/mp4">
        ...
        <b-modal content-class="create-group-popup create-rooms-popup"  id="roomSetting" size="lg" centered  >
            ...
            <div class="form-container">
                <b-form>
                    ...
                    <div>
                        <label for="room-name">Room Name</label>
                        <b-form-input id="room-name" class="text-input" type="text" placeholder="Room Name"></b-form-input>
                    </div>
                    ...
                    <div class="friends">
                        ...
                        <!--remove img btn-->
                        <b-button variant="default" v-if="selectedCover" class="remove font-weight-bold mt-4 bg-red-opacity-1 no-shadow color-red w-100 p-2">
                            Remove Photo
                        </b-button>
                    </div> 
                </b-form>
        ...
        initPusher() {
            // if(process.client) {
                ...
                this.auctionChannel.bind('pusher:member_added', member => {
                    ...
                    console.log('member added >> ', member, member.id, member.info);
                ...
                this.auctionChannel.bind('pusher:member_removed', member => {
                    // for example:
                    console.log('all members >> ', this.members, th.members);
                    console.log('member removed >> ', member, this.members[member.id]);
